...
namespace daily.Global
{
    ...
    public class GlobalVariable
    {
        ...
        /// 默认提示音乐路径
        /// </summary>
        public static string DEFAULT_MUSIC_PATH = null;
        /// <summary>
        /// 默认提示次数
        /// </summary>
        ...
        /// 开机运行
        /// </summary>
        public static bool RUN_ON_START = false;
        /// <summary>
        /// 后台运行
        /// </summary>
        public static bool RUN_BACKGROUND = false;
        /// <summary>
        /// 当日未执行任务
        /// </summary>
        public static ArrayList LST_TODAY_UNDO_DAILY = new ArrayList();
        /// <summary>
        /// 正在执行的日程
        /// </summary>
        public static Dictionary<string, int> HASH_BEGIN_DOING_DAILY = new Dictionary<string, int>();
        /// <summary>
        /// 正在执行的日程
        /// </summary>
        public static Dictionary<string, DateTime> HASH_DOING_DAILY_LAST_TIME = new Dictionary<string, DateTime>();
        #endregion
    ...
    {
        #region 方法
        public static DialogResult MessageInfo(String message, String caption)
        {
            return MessageBox.Show(message, caption, MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        public static DialogResult MessageError(String message, String caption)
        {
            return MessageBox.Show(message, caption, MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        public static DialogResult MessageWarnning(String message, String caption)
        {
            return MessageBox.Show(message, caption, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        public static DialogResult MessageAsk(String message, String caption)
        {
            return MessageBox.Show(message, caption, MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        }
        public static DialogResult MessageInfo(String code)
        {
            return MessageBox.Show(code, code, MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        public static DialogResult MessageError(String code)
        {
            return MessageBox.Show(code, code, MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        public static DialogResult MessageWarnning(String code)
        {
            return MessageBox.Show(code, code, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        #endregion
    }
    ...
    /// 后台运行事件
    /// </summary>
    public class RunBackgroundEventArgs : EventArgs
    {
        private RunBackgroundState _runState = RunBackgroundState.GoOn;
        /// <summary>
        /// 运行状态
        /// </summary>
        public RunBackgroundState RunState
        {
            set { _runState = value; }
            get { return _runState; }
        }
        public RunBackgroundEventArgs()
        { }
        public RunBackgroundEventArgs(RunBackgroundState runState)
        {
            _runState = runState;
        }
    }
    ...
    /// 后台运行状态，结构体
    /// </summary>
    public enum RunBackgroundState
    {
        /// <summary>
        /// 后台运行
        /// </summary>
    ...
    public sealed class ChineseCalendarInfo
    {
        ...
        /// <returns></returns>
        //public static DateTime GetNowOfLunar()
        //{
        //    DateTime lunarDate = GlobalVariable.LUNAR_TODAY;
        //    lunarDate = lunarDate.Add(new TimeSpan(DateTime.Now.Hour, DateTime.Now.Minute, DateTime.Now.Second));
        //    return lunarDate;
        //}
        #endregion
